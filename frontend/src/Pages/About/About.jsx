...
const About = ()=>{
    return (
        <div style={{height:"100vh",overflowY:"clip"}}>
            ...
            <div style={{height:"90vh",display:"flex",flexFlow:"column",alignItems:"center",justifyContent:"center"}}>
                <h1>About</h1>
                <h3 style={{padding:"5rem", textAlign:"center"}}>Welcome to the ECO TRACK, the ultimate tool for monitoring and reducing your online carbon footprint. Our innovative platform uses open-source API's to calculate the carbon emissions generated by your internet usage. Each time you visit a website, our tracker runs in the background, calculating the data usage and energy consumption required to load the page. With this information, we can provide you with a real-time measurement of your carbon footprint and give you insights into how you can reduce your impact.
